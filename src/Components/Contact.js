      ...
      <section id="contact">
         ...
         <div className="row">
            <div className="eight columns">
               ...
               <form action="https://formspree.io/levbio@yahoo.com" method="post" id="contactForm" name="contactForm">
					<fieldset>
                  ...
                  <div>
						   ...
						   <input type="text" defaultValue="" size="35" id="contactEmail" name="_replyto" />
                  </div>
